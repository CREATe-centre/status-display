...
wp_enqueue_style( 'status-css', plugins_url( 'css/page.css', __FILE__ ) );
wp_enqueue_script( 'google-maps',
'https://maps.googleapis.com/maps/api/js?libraries=visualization&sensor=false' );
wp_enqueue_script( 'google-js-api', 'https://www.google.com/jsapi' );
wp_enqueue_script( 'status-userbasic', plugins_url( 'js/ClassUserBasic.js', __FILE__ ) );
wp_enqueue_script( 'status-chart', plugins_url( 'js/ClassChart.js', __FILE__ ) );
wp_enqueue_script( 'status-map', plugins_url( 'js/ClassMap.js', __FILE__ ) );
?>
